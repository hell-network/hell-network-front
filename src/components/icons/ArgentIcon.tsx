export default function ArgentIcod({ className }: { className?: string }) {
  return (
    <svg
      id="katman_1"
      ...
      y="0px"
      viewBox="0 0 800 600"
      width="100" // Set the width to 80px
      height="60" // Set the height to 24px
      xmlSpace="preserve"
      style={{ width: '100px', height: '60px' }} // Add CSS inline styles
    >
      <style
        type="text/css"
      ...
      <path
        className="st0"
        d="M709.1,263.1H695v-17c0-0.9-0.4-1.7-1.1-2.3c-0.7-0.5-1.5-0.7-2.4-0.5l-12.4,3c-1.3,0.3-2.2,1.5-2.2,2.8v13.9
      ...
      <path
        className="st0"
        d="M633.4,262c-7.4,0-13.1,2.3-17.2,6.8V266c0-1.6-1.2-2.9-2.8-2.9h-13.1c-1.6,0-2.8,1.2-2.8,2.9v71.4
      ...
      <path
        className="st0"
        d="M567.5,294.1h-27.8c0.2-2.5,0.5-4.2,1-5.7l0-0.1c1.8-6.2,6.2-9.5,12.6-9.5c6.9,0,11.8,3.7,13.4,10.4
      ...
      <path
        className="st0"
        d="M491,301c0,8.1-0.3,10.2-1,12.7c-1.5,6.1-6,9.7-12.3,9.7c-6.3,0-11.2-3.7-13.1-9.9c-0.6-1.6-1.3-5-1.3-12.3
      ...
      <path
        className="st0"
        d="M438.2,263.4c-2-0.8-4.2-1.2-6.7-1.2c-6.7,0-12.1,2.7-16.2,8.1V266c0-1.6-1.3-2.9-2.8-2.9h-13.1
      ...
      <path
        className="st0"
        d="M364.7,306.9v6.5c0,7.7-8,12.4-15.8,12.4c-5.2,0-10.8-2.3-10.8-8.7c0-6.5,5.5-10.2,15.1-10.2H364.7z M352.3,262
