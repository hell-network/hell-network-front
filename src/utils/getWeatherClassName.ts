const getWeatherClassName = (skyInfoStr: string, dayTimeYn: boolean) => {
  let className = ''
  let weatherInfoName = ''
  // sky
  // ① 1 : 맑음
  ...
  switch (skyInfoStr) {
    ...
    // case '24':
    //   className = dayTimeYn ? 'wi wi-day-rain' : 'wi wi-night-alt-rain'
    //   weatherInfoName = '구름 적고 소나기'
    //   break
    case '25':
      className = dayTimeYn ? 'wi wi-day-sprinkle' : 'wi wi-night-alt-sprinkle'
      weatherInfoName = '구름 적고 빗방울'
      break
    case '26':
      className = dayTimeYn ? 'wi wi-day-rain-mix' : 'wi wi-night-alt-rain-mix'
      weatherInfoName = '구름 적고 빗방울 눈날림'
      break

    case '27':
      className = dayTimeYn ? 'wi wi-day-snow-wind' : 'wi wi-night-snow-wind'
      weatherInfoName = '구름 적고 눈날림'
      break
    ...
    // case '34':
    //   className = dayTimeYn ? 'wi wi-snow' : 'wi wi-night-alt-snow'
    //   weatherInfoName = '구름 많고 소나기 '
    //   break

    case '35':
      className = dayTimeYn ? 'wi wi-sprinkle' : 'wi wi-night-alt-sprinkle'
      weatherInfoName = '구름 많고 빗방울 '
      break

    case '36':
      className = dayTimeYn ? 'wi wi-rain-mix' : 'wi wi-night-alt-rain-mix'
      weatherInfoName = '구름 많고 빗방울 눈날림 '
      break

    case '37':
      className = dayTimeYn ? 'wi wi-snow-wind' : 'wi wi-night-alt-snow-wind'
      weatherInfoName = '구름 많고 눈 날림 '
      break
    ...
    case '45':
      className = dayTimeYn ? 'wi wi-sprinkle' : 'wi wi-night-alt-sprinkle'
      weatherInfoName = '흐리고 빗방울'
      break

    case '46':
      className = dayTimeYn ? 'wi wi-rain-mix' : 'wi wi-night-alt-rain-mix'
      weatherInfoName = '흐리고 빗방울눈날림'
      break

    case '47':
      className = dayTimeYn ? 'wi wi-snow-wind' : 'wi wi-night-alt-snow-wind'
      weatherInfoName = '흐리고 눈날림'
      break
